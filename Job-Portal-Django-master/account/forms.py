...
class EmployeeRegistrationForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['c_company'].label = "Current Company :"
        self.fields['c_ctc'].label = "Current CTC :"
        ...
        self.fields['c_company'].widget.attrs.update(
            {
                'placeholder': 'Current Company',
            }
        )
        self.fields['c_ctc'].widget.attrs.update(
            {
    ...
    class Meta:
        ...
        fields = ['first_name', 'last_name', 'email', 'password1', 'password2', 'gender','college','degree','skills','c_company','c_ctc','experience','grade']
